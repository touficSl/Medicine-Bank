        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel panel-bordered">
                    <!-- form start -->
                    <form role="form" class="form-edit-add" action="{{ Route('confirm_delivery') }}" method="POST">
                        ...
                        <div class="panel-body">
                            ...
                            @if($edit)
                                @include('voyager::partials.orderMedications', ['medications' => $medications, 'from' => '1'])
                            @endif
                        ...
                        <div class="panel-footer">
                            @section('submit-buttons')
                                <button type='submit' class="btn btn-primary save">Confirm delivery</button>
                            @stop
